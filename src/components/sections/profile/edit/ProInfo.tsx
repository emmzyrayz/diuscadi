      ...
      <div className={cn('grid', 'grid-cols-1', 'md:grid-cols-2', 'gap-x-8', 'gap-y-8')}>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <LuGraduationCap className={cn('absolute', 'left-6', 'top-1/2', '-translate-y-1/2', 'text-muted-foreground', 'w-4', 'h-4')} />
            <select className={cn('w-full', 'bg-muted', 'border-2', 'border-slate-50', 'rounded-2xl', 'pl-12', 'pr-6', 'py-4', 'text-sm', 'font-bold', 'text-slate-700', 'outline-hidden', 'focus:border-primary/20', 'focus:bg-backgroundround', 'transition-all', 'appearance-none', 'cursor-pointer')}>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <LuBuilding2 className={cn('absolute', 'left-6', 'top-1/2', '-translate-y-1/2', 'text-muted-foreground', 'w-4', 'h-4')} />
            <input
              type="text"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <LuChartBar className={cn('absolute', 'left-6', 'top-1/2', '-translate-y-1/2', 'text-muted-foreground', 'w-4', 'h-4')} />
            <select className={cn('w-full', 'bg-muted', 'border-2', 'border-slate-50', 'rounded-2xl', 'pl-12', 'pr-6', 'py-4', 'text-sm', 'font-bold', 'text-slate-700', 'outline-hidden', 'focus:border-primary/20', 'focus:bg-backgroundround', 'transition-all', 'appearance-none', 'cursor-pointer')}>
