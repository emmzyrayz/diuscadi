...
const ctaCards = [
  {
    ...
    // TODO: route to /profile/applications?type=mentorship when built
    action: "mentorship",
  },
  {
    ...
    // TODO: route to /sponsor when built
    action: "sponsorship",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className={cn("grid", "grid-cols-1", "lg:grid-cols-2", "gap-6")}>
        {/* Refer a Friend — now wired to /profile/referral */}
        <motion.div
          whileHover={{ x: 5 }}
          ...
          <div className={cn("flex", "items-center", "gap-4")}>
            ...
            <div>
              ...
              <p className={cn("text-xs", "font-bold", "text-emerald-700")}>
                Earn Career Points for every invite
              </p>
            </div>
          </div>
          <LuArrowRight
        ...
        {/* Verify Profile — still coming soon */}
        <motion.div
          whileHover={{ x: 5 }}
