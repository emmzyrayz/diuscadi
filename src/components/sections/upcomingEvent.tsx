    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <motion.div
          ...
          className="relative w-full rounded-[2.5rem] overflow-hidden shadow-2xl bg-foreground"
        >
          ...
          <div className="absolute inset-0 w-full h-full z-0">
            ...
            <div className="absolute inset-0 bg-linear-to-r from-foreground via-foreground/90 to-transparent md:to-foreground/40" />
          </div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-8 md:p-16 gap-10">
            ...
            <div className="w-full md:w-2/3 space-y-8">
              {/* Event Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background/10 backdrop-blur-md border border-background/20 text-background text-sm font-semibold tracking-wide uppercase">
              ...
              {/* Title & Description */}
              <div className="space-y-4 text-background text-left">
              ...
              <div className="flex flex-wrap items-center gap-6 pt-2">
                <div className="flex items-center gap-3 text-slate-200 bg-background/5 px-4 py-3 rounded-xl backdrop-blur-sm border border-background/10">
            ...
            <div className="w-full md:w-1/3 flex flex-col items-start md:items-end gap-6 border-t border-background/10 md:border-t-0 md:border-l pt-8 md:pt-0 md:pl-10 mt-4 md:mt-0">
              ...
              <div className="flex flex-col w-full gap-3">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full h-14 text-lg text-background border-background/20 bg-background/5 hover:bg-background/10 hover:text-background backdrop-blur-md"
                >
                  View Full Agenda
                </Button>
              </div>
