"use client";
// sections/admin/invites/AIToolbar.tsx

import React, { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { IconType } from "react-icons";
import { LuSearch, LuActivity, LuArrowUpDown } from "react-icons/lu";
...
export const AdminInvitesToolbar: React.FC<Props> = ({
  onSearchChange,
  onStatusChange,
}) => {
      ...
      >
        ...
        >
          <InviteDropdown
            ...
            icon={LuActivity}
            current={status}
            options={["All", "active", "used", "expired", "revoked"]}
            onChange={(v) => {
              setStatus(v);
          ...
          <InviteDropdown
            ...
            icon={LuArrowUpDown}
            current="Newest"
            options={["Newest", "Oldest", "Most Used"]}
            onChange={() => {}}
          />
        </div>
      </div>
