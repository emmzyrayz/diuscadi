      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-background rounded-[2.5rem] shadow-2xl overflow-hidden"
          >
            <button
              onClick={onClose}
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  <LuUser className="w-3 h-3" /> Applicant
                </p>
                <div
                  className={cn(
              ...
              <div className="space-y-2">
                ...
                >
                  <Icon className="w-3 h-3" /> Requested{" "}
                  {app.type === "committee" ? "Committee" : "Skills"}
                </p>
                {app.type === "committee" ? (
                  <div
                    className={cn(
                  ...
                  >
                    <p
                      className={cn(
                        "text-sm font-black text-foreground uppercase tracking-wide",
                      )}
                    >
                  ...
                  <div
                    className={cn(
                      "p-4 bg-muted rounded-2xl border border-border flex flex-wrap gap-2",
                    )}
                  >
              ...
              {app.reason && (
                <div className="space-y-2">
                  ...
                  >
                    <LuFileText className="w-3 h-3" /> Reason
                  </p>
                  <div
                    className={cn(
                      "p-4 bg-muted rounded-2xl border border-border",
            ...
            {isPending && (
              <div className="flex items-center gap-3 p-8 pt-0">
                ...
                >
                  <LuCircleX className="w-4 h-4" /> Reject
                </button>
                <button
                  onClick={onApprove}
                  className={cn(
                ...
                >
                  <LuCircleCheck className="w-4 h-4" /> Approve
                </button>
              </div>
            )}
          </motion.div>
