      ...
      {isOpen && (
        <div className="fixed inset-0 z-120 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-background rounded-[3rem] shadow-[0_35px_60px_-15px_rgba(225,29,72,0.3)] overflow-hidden border border-rose-100"
          >
            {/* Header Close */}
            <button
              onClick={onClose}
            ...
            <div className="p-10 text-center">
              ...
              <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest leading-relaxed px-4">
              ...
              <div className="mt-6 flex items-start gap-3 text-left p-4 bg-muted rounded-2xl">
                <LuTriangleAlert className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
                <p className="text-[9px] font-bold text-muted-foreground uppercase leading-normal tracking-tight">
                  <span className="text-foreground font-black">Warning:</span>{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-3 p-8 pt-0">
              <button
                onClick={onClose}
                className="flex-1 px-6 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:bg-muted transition-all"
              >
                Keep Profile
              </button>
