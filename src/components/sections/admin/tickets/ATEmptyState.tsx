    ...
    >
      ...
      <div className="mt-10 flex flex-col sm:flex-row gap-4">
        {isSearchActive ? (
          <button
            onClick={onReset}
            className="flex items-center gap-3 px-8 py-4 bg-foreground text-background rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-primary hover:text-foreground transition-all shadow-xl shadow-foreground/10"
          >
            <LuRefreshCcw className="w-4 h-4" />
            Clear Current Filters
          </button>
        ) : (
          <button className="flex items-center gap-3 px-8 py-4 bg-foreground text-background rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-primary hover:text-foreground transition-all shadow-xl shadow-foreground/10">
