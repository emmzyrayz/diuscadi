  ...
  return (
    <div className="fixed inset-0 z-150 flex items-center justify-center p-4 bg-foreground/90 backdrop-blur-md">
      <div className="relative w-full max-w-lg bg-background rounded-[3rem] shadow-2xl overflow-hidden">
        ...
        <button
          onClick={onClose}
          className="absolute top-6 right-6 p-2 text-muted-foreground hover:text-foreground z-20"
        >
        ...
        <div className="p-10 flex flex-col items-center text-center">
          ...
          <div className="w-full aspect-square bg-foreground rounded-[2.5rem] relative flex items-center justify-center overflow-hidden border-4 border-border mb-8">
            <div className="absolute inset-0 border-40 border-foreground/50 z-10" />{" "}
            {/* Framing effect */}
          ...
          <div className="w-full space-y-4">
            <div className="flex items-center gap-3">
              <div className="h-px flex-1 text-muted" />
            ...
            <div className="relative group">
              <LuKeyboard className="absolute left-5 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-primary transition-colors" />
              <input
                type="text"
            ...
            <button className="w-full py-5 bg-foreground text-background rounded-2xl text-[11px] font-black uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-primary hover:text-foreground transition-all">
