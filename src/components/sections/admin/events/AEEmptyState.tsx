...
export const AdminEventsEmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <motion.div
      ...
      className="w-full py-24 bg-background border-2 border-dashed border-border rounded-[3rem] flex flex-col items-center justify-center text-center px-6"
    >
      ...
      <div className="relative mb-8">
        ...
        <div className="absolute -bottom-4 -left-4 w-12 h-12 text-muted rounded-full blur-md -z-10" />
      </div>
      ...
      {type === "none-created" ? (
        <button
          ...
          className="mt-10 group flex items-center gap-3 px-10 py-5 bg-foreground text-background rounded-[2rem] hover:bg-primary hover:text-foreground transition-all shadow-2xl shadow-foreground/20 active:scale-95"
        >
        ...
        <div className="mt-8 flex items-center gap-2 px-4 py-2 bg-muted rounded-full border border-border">
