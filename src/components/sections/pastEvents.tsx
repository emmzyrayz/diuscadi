        ...
        <div className={cn('grid', 'grid-cols-1', 'md:grid-cols-2', 'lg:grid-cols-3', 'gap-8')}>
          {PAST_EVENTS.map((event, idx) => (
            <motion.div
              ...
              className={cn('group', 'flex', 'flex-col', 'bg-background', 'rounded-3xl', 'overflow-hidden', 'border', 'border-border', 'shadow-sm', 'hover:shadow-xl', 'hover:border-primary/20', 'transition-all', 'duration-300')}
            >
              {/* Image Container */}
              ...
              <div className={cn('flex', 'flex-col', 'grow', 'p-6', 'md:p-8')}>
                ...
                <div className={cn('mt-auto', 'pt-4', 'border-t', 'border-border', 'flex', 'items-center', 'justify-between')}>
                  <span className={cn('text-sm', 'font-semibold', 'text-foreground', 'group-hover:text-primary', 'transition-colors', 'flex', 'items-center', 'gap-2')}>
                    Event Log & Gallery
